...
def main(memory, seed=42, nchunks=32):
    ...
    src_dir = f"/home/lama722b/nanite_lm/data/fineweb-longterm/de"
    out_dir = f"{src_dir}_shuffled"
    os.makedirs(out_dir, exist_ok=True)
    work_dir = "/data/horse/ws/lama722b-nanite-lm/slurm_logs/de_lt"
    prefix = f"{dataset}.chunk."
    orig_extension = ".jsonl"
    cat_command = "cat {}"
    allow_patterns = "data/deu_Latn/train/*.parquet"
    suffix = ".jsonl"
    k_validation = 10000  # Number of lines to take from each chunk for validation

    # Setup terashuf
    terashuf_dir = setup_terashuf("/home/lama722b/nanite_lm/data/fineweb-longterm/de")
    ...
    parquet_to_jsonl(
        dataset,
        work_dir,
        "/home/lama722b/nanite_lm/data/fineweb-longterm/de/data/deu_Latn/train",
        src_dir,
    )
